    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="embed-responsive embed-responsive-16by9">
          {$tree_appearance.appearance_3d}  
        </div>  
      </div>
      <div class="col-sm-6">
        <div class="alert alert-secondary">
          <h3 class="fontsizebox">{$tree_appearance.appearance_title}</h3>
        </div>
        <div class="alert alert-secondary">
          <h3 class="text-justify fontsizebox">{$tree_appearance.appearance_content}</h3>
        </div>
        <div>
        {if $isAdmin}
          <!--a href="admin.php?op=tree_appearance_form&appearance_sn={$tree_appearance.appearance_sn}" class="btn btn-warning">編輯文章</a-->
          <a href="admin.php?op=delete_tree_appearance&appearance_sn={$tree_appearance.appearance_sn}" class="btn btn-danger">刪除文章</a>
        {/if}
      </div>
      </div>
    </div>

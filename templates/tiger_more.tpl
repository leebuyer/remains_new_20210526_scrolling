<div class="container">
  ...
  <div class="row">
    {foreach from=$all_tiger_more item=more}
      <div class="col-md-4 text-center mt-3">
        <a href="tiger_more.php?more_sn={$more.more_sn}"><img src="{$more.pic}" class="img-thumbnail img-fluid" alt="{$more.more_title}"></a>
        <div class="caption mt-3">
          <div style="height: 60px;">
            <h5 class="font-weight-bold"><a href="tiger_more.php?more_sn={$more.more_sn}">{$more.more_title}</a></h5>
          </div>
        </div>
      </div>
    {foreachelse}
